...
st.markdown("""
    <style>
    /* ── LIGHT THEME ──────────────────────────────────── */
    [data-testid="stAppViewContainer"][data-theme="light"] { background: linear-gradient(135deg,#ffeef8 0%,#e3f2fd 50%,#fff9e6 100%); }
    [data-testid="stSidebar"][data-theme="light"]          { background: linear-gradient(180deg,#f8e8ff 0%,#e8f5e9 100%); }

    /* ── DARK THEME ───────────────────────────────────── */
    [data-testid="stAppViewContainer"][data-theme="dark"]  { background: linear-gradient(135deg,#1a0a2e 0%,#0d1b2e 50%,#1a1a0a 100%); }
    [data-testid="stSidebar"][data-theme="dark"]           { background: linear-gradient(180deg,#1e1030 0%,#0e2010 100%); }
    ...
    .stTabs [aria-selected="true"]           { background:linear-gradient(90deg,#7b1fa2 0%,#1565c0 100%) !important; color:white !important; }
    .stButton>button                         { border-radius:8px; border:none; font-weight:500;
                                               background:linear-gradient(90deg,#ba68c8 0%,#64b5f6 100%); color:white; }
    .stButton>button:hover                   { background:linear-gradient(90deg,#9c27b0 0%,#1976d2 100%); }
        ...
        if selected_participant:
            ...
            for x in range(8):
                for y in range(8):
                    ...
                    ax.add_patch(plt.Rectangle((x - 0.5, y - 0.5), 1, 1, edgecolor=cell_ec, facecolor=cell_fc))
                    ax.text(x, y, str(y * 8 + x), ha='center', va='center', fontsize=8, color=cell_tc)
...
with tab_about:
    ...
    wendy_img = get_image_base64("Images/Wendy.png")
    thomas_img = get_image_base64("Images/Thomas.png")
    george_img = get_image_base64("Images/George.png")
    ...
    with col1:
        st.markdown("""
        <div class="team-card">
            <div class="photo-psychology">
                <img src="Images/Wendy.png" class="team-photo">
            </div>
            <div class="member-name">Dr. Wendy Ross</div>
    ...
    # with col1:
    #     st.markdown("""<div class="team-card"><div class="photo-psychology">
    #         <img src="Images/Thomas.png" width="150">
    #         </div>
    #         <div class="member-name">Dr. Wendy Ross</div><div class="member-role">Senior Lecturer in Psychology at London Metropolitan University</div></div>""",
    #         unsafe_allow_html=True)
    with col2:
        st.markdown("""<div class="team-card"><div class="photo-psychology">
            <img src="https://cdn-icons-png.flaticon.com/512/847/847969.png"></div>
            <div class="member-name">Thomas Ormerod</div><div class="member-role">Professor of Psychology at University of Sussex</div></div>""",
            unsafe_allow_html=True)
    with col3:
        st.markdown("""<div class="team-card"><div class="photo-psychology">
            <img src="https://cdn-icons-png.flaticon.com/512/847/847969.png"></div>
            <div class="member-name">Dr. George Georgiou</div><div class="member-role">Senior Lecturer in Psychology at University of Hertfordshire</div></div>""",
            unsafe_allow_html=True)
    ...
    with col1:
        st.markdown("""<div class="team-card"><div class="photo-scdm">
            <img src="https://cdn-icons-png.flaticon.com/512/847/847969.png"></div>
            <div class="member-name">Prapa Rattadilok</div><div class="member-role">Head of Computer Science and Applied Computing and Reader in Computer Science</div></div>""",
            unsafe_allow_html=True)
    with col2:
        st.markdown("""<div class="team-card"><div class="photo-scdm">
            <img src="https://cdn-icons-png.flaticon.com/512/847/847969.png"></div>
            <div class="member-name">Dr. Subeksha Shrestha</div><div class="member-role">Deputy Course Leader and Lecturer in Data Analytics at London Metropolitan University</div></div>""",
            unsafe_allow_html=True)
    with col3:
        st.markdown("""<div class="team-card"><div class="photo-scdm">
            <img src="https://cdn-icons-png.flaticon.com/512/847/847969.png"></div>
            <div class="member-name">Arnabi Modak</div><div class="member-role">MSc in Data Analytics at London Metropolitan University</div></div>""",
            unsafe_allow_html=True)
    with col4:
        st.markdown("""<div class="team-card"><div class="photo-scdm">
            <img src="https://cdn-icons-png.flaticon.com/512/847/847969.png"></div>
            <div class="member-name">Upendo Daudi Manya</div><div class="member-role">MSc in Data Analytics at London Metropolitan University</div></div>""",
            unsafe_allow_html=True)
    with col5:
        st.markdown("""<div class="team-card"><div class="photo-scdm">
            <img src="https://cdn-icons-png.flaticon.com/512/847/847969.png"></div>
            <div class="member-name">Ganegodage Chathuranga Madushan Dharmarathne</div><div class="member-role">MSc in Data Analytics at London Metropolitan University</div></div>""",
            unsafe_allow_html=True)
